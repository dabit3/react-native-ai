...
/// On iOS 16+: Uses additional addsPunctuation option.
/// On iOS 13+: Uses requiresOnDeviceRecognition and taskHint options.
///
...
class StreamingTranscriptionSession {
  ...
  private func stopInternal() {
    ...
    // Remove audio tap first (before stopping engine)
    audioEngine.inputNode.removeTap(onBus: 0)
