...
- LLM support for [OpenAI](https://openai.com/) GPT-5.2 + GPT-5 mini, [Anthropic](https://anthropic.com) Claude Opus/Sonnet 4.5 & 4.6 + Haiku 4.5, and [Gemini](https://makersuite.google.com)
